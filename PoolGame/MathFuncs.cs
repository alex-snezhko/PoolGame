...
namespace PoolGame
{
	static class MathFuncs
	{
		...
		public static float PathCompletedWhenCollidedWithLine(ValueTuple<Vector2, Vector2> path, ValueTuple<Vector2, Vector2> wall, float d)
		{
		...
		public static float PathCompletedWhenMovingPointsCollided(ValueTuple<Vector2, Vector2> line1, ValueTuple<Vector2, Vector2> line2, float d)
		{
		...
		public static float SmallestDistance(ValueTuple<Vector2, Vector2> line1, ValueTuple<Vector2, Vector2> line2)
		{
		...
		public static float SmallestDistance(ValueTuple<Vector2, Vector2> line, Vector2 point)
		{
		...
		public static Vector2 SmallestDistanceVector(ValueTuple<Vector2, Vector2> line, Vector2 point)
		{
			// p1 is farther from point than p2
			Vector2 p1 = (point - line.Item1).Length() > (point - line.Item2).Length() ? line.Item1 : line.Item2;
			Vector2 p2 = p1 == line.Item1 ? line.Item2 : line.Item1;
